...
const Login = () => {
    ...
    return (
        <View>
            <Appbar.Header style={{ backgroundColor: colors.primary }} mode='small'>
            ...
            <View style={styles.logonContainer}>
                <Text style={styles.loginText}>Please enter logon details.</Text>
                <TextInput
                ...
                <View style={styles.footer}>
                    ...
                    <Text>
                        If you can bank with us, you can manage your accounts online. First,
                        you will need to create your logon details.
                    </Text>
